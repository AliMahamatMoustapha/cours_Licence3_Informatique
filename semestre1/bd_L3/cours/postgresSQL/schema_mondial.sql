...
DROP TABLE IF EXISTS MountainOnIsland, islandIn, locatedOn, located, mergesWith, geo_Estuary, geo_Source, geo_Lake, geo_Sea, geo_River, geo_Island, geo_Desert, geo_Mountain, River, Sea, Lake, Island, Desert, Mountain;
DROP TYPE GeoCoord;
DROP TABLE IF EXISTS isMember, Organization, encompasses, borders, Continent, EthnicGroup, Religion, Language, Politics, Population, Economy, Province, City, Country;
